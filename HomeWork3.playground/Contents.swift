...
for index in 0..<cart.count {
    ...
    if (cart[index].1) < 5000.00 && (cart[index].3) == "s1151" {
        print("------------------- \(index+1) -------------------------------")
        print("- name: \(cart[index].0)")
        print("- price: \(cart[index].1) \(cart[index].2)")
        print("- socket: \(cart[index].3)")
...
func intelProducts () {
    ...
    for index in 0..<cart.count {
        ...
        if cart[index].4 == "Intel"{
            print("\(index+1). Name: \(cart[index].0)")
        }
...
func productsWithLimitedProce (maxPrice: Double) {
    
    print(" ------------------- Товари з ціною менше \(maxPrice) -------------------------------")
    for index in 0..<cart.count {
        
        if cart[index].1 < maxPrice {
...
productsWithLimitedProce(maxPrice: 4000)
